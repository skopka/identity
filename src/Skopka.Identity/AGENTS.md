...
- Core registration, external-login lifecycle and bounded user-query services are
  registered by `AddSkopkaIdentity<TProfile>()`; PostgreSQL supplies their stores.
