...
namespace Skopka.Identity.Ef.Migrations
{
    ...
    public partial class AddLogicalIdentitySessions : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(
                """
                UPDATE identity_refresh_sessions AS tokens
                SET
                    user_id = sessions.user_id,
                    security_stamp = sessions.security_stamp,
                    client_name = sessions.client_name,
                    device_name = sessions.device_name,
                    expires_at = sessions.expires_at,
                    revoked_at = sessions.revoked_at
                FROM identity_sessions AS sessions
                WHERE sessions.session_id = tokens.session_id;
                """);
