        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    device_code = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    browser_verifier_hash = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    ...
                    device_display_name = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    client_id = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    return_url = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: true),
                    session_client_name = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    session_device_name = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    resolved_by_user_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    approved_security_stamp = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    consumption_id = table.Column<Guid>(type: "TEXT", nullable: true),
